    ...
    public static class MenuEx
    {
        ...
        public static VRC.UI.Elements.QuickMenu Instance
        {
            get
            {
                ...
                {
                    _quickMenuInstance = scarfaceMain.UserInterface.GetComponentInChildren<VRC.UI.Elements.QuickMenu>(true);
                }
        ...
        public static VRC.UI.Elements.MainMenu MMInstance
        {
            get
            {
                ...
                {
                    _mainMenuInstance = scarfaceMain.UserInterface.GetComponentInChildren<VRC.UI.Elements.MainMenu>(true);
                }
